...
const AuthLayout = ({ children }) => {
  return (
    <div className="flex">
        ...
        <div className="hidden md:block w-[40vw] h-screen bg-green-50 bg-auth-bg-image bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
            <div className="w-48 h-48 rounded-[40px] bg-green-600 absolute -top-7 -left-5"></div>
            <div className="w-48 h-56 rounded-[40px] border-[20px] border-red-600 absolute top-[30%] -right-10"></div>           
